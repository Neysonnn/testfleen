<?php
/*
Слив платного шаблона HostinPL 5.6 для VipAdmin.Club by PavelDomatov
*/
?>
<html lang="ru">
   <head>
      <meta charset="utf-8" />
      <title>Fleen-Host | Админ Панель</title>
         ...
         <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            <ul class="menu-nav">
               ...
               <li class="menu-item menu-item<?php if($activesection == "admin/repo"): ?>-active<?php endif; ?>" aria-haspopup="true">
			    ...
			    <li class="menu-item menu-item<?php if($activesection == "admin/fs"): ?>-active<?php endif; ?>" aria-haspopup="true">
                  <a href="/admin/fs" class="menu-link">
                  <i class="menu-icon fa fa-folder"></i>
                  <span class="menu-text">Автоустановка FS</span>
                  </a>
               </li>
			   <li class="menu-item menu-item<?php if($activesection == "admin/news"): ?>-active<?php endif; ?>" aria-haspopup="true" data-menu-toggle="hover">
                  ...
                  <div class="menu-submenu" kt-hidden-height="120" style="">
                     ...
                     <ul class="menu-subnav">
                        ...
                        <li class="menu-item menu-item-submenu <?php if($activesection == "admin/sites" && $activeitem == "index"): ?>menu-item-here<?php endif; ?>" aria-haspopup="true" data-menu-toggle="hover">
                           <a href="/admin/sites" class="menu-link menu-toggle">
                           <i class="menu-bullet menu-bullet-line">
                           <span></span>
                           </i>
                        ...
                        <li class="menu-item menu-item-submenu <?php if($activesection == "admin/forums" && $activeitem == "index"): ?>menu-item-here<?php endif; ?>" aria-haspopup="true" data-menu-toggle="hover">
                           <a href="/admin/forums" class="menu-link menu-toggle">
                           <i class="menu-bullet menu-bullet-line">
                           <span></span>
                           </i>
                           <span class="menu-text">Стили для Форума</span>
                           <i class="menu-arrow"></i>				   
                           </a>
                        </li>
                     </ul>
               ...
               <li class="menu-item menu-item" aria-haspopup="true">
                  <a href="https://fleen-host.ru/main/index" class="menu-link">
...
<a class="nav-link" href="https://vk.com/fullger01"><span class="badge badge-danger">Произошла ошибка в админ-панели или хочёшь дополнить её функционал? -  Скорее жми сюда и пиши директору об этом!</span></a>
                     </li>
                  </ul>
               </div>
            </div>
            <div class="topbar">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                           <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                              ...
                              <path d="M3.00065168,20.1992055 C3.38825852,15.4265159 7.26191235,13 11.9833413,13 C16.7712164,13 20.7048837,15.2931929 20.9979143,20.2 C21.0095879,20.3954741 20.9979143,21 20.2466999,21 C16.541124,21 11.0347247,21 3.72750223,21 C3.47671215,21 2.97953825,20.45918 3.00065168,20.1992055 Z" fill="#000000" fill-rule="nonzero" />
	  	  			   	  ...
	  	  			   	  <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-image: url(https://pbs.twimg.com/media/EZgUmLLXkAIGFMm.jpg);">
				<a class="nav-link"><span class="badge badge-primary">Онлайн - <b id="online"></b> </span></a>
				<a class="nav-link"><span class="badge badge-primary">Роль -  <?if($user_access_level == 3):?> Администратор<?elseif($user_access_level == 2):?>Тех.поддержка<?endif;?></small></b> </span></a>
				</a>
			  <div class="collapse navbar-collapse">
				...
				<span class="navbar-text text-hover-primary font-weight-bold mr-2">
				</span>
				<span class="navbar-text"> 
				  <script language="JavaScript">
					   ...
					   if (r.length > 0) {
						  ...
						  else if (r.indexOf("google") >= 0)       Site = "Google";
						  else if (r.indexOf("vk") >= 0)       Site = "VK";
						  else if (r.indexOf("mail") >= 0)       Site = "MAIL.RU";
						  if (Site.length > 0) {
					   ...
					   document.write("</b>");
					</script><b align="center"><a class=" nav-link" href="https://vk.com/fullger01"><span class="badge badge-danger">Директор хостинга</span></a></b>
				</span>
			  </div>
			</nav>
