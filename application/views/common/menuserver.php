      ...
      <div class="card-toolbar">
         <ul class="nav nav-tabs nav-bold nav-tabs-line">
            ...
            <li class="nav-item">
               ...
               <span class="nav-text">Дополнения</span>
               </a>
            </li>
            <?endif;?>
			<?php if($server['game_code'] == "mtasa" || $server['game_code'] == "samp" || $server['game_code'] == "crmp" || $server['game_code'] == "crmp037" || $server['game_code'] == "unit"): ?>
            <li class="nav-item">
               <a href="/servers/autofs/index/<?php echo $server['server_id'] ?>" class="nav-link <?php if($activesection == "servers" && $activeitem == "autofs"): ?>active<?php endif; ?>">
               <span class="nav-icon">
               <i class="fa fa-fast-forward"></i>
               </span>
               <span class="nav-text">Автоустановка FC</span>
               </a>
            </li>
            <?php endif; ?>
         </ul>
