			...
			<form id="orderForm" method="POST" style="padding:0px; margin:0px;">
				...
				<div class="col-xl-8 col-xxl-8">
					<div class="alert alert-success" role="alert">
						<div class="alert-text">[NEW] Web-хостинг доступен на Ispmanager, это очень удобно!</div>
					</div>
					</div>
					<div class="col-xl-8 col-xxl-8">
						...
						<div class="card card-custom card-shadowless bg-gray-100 gutter-b">
							...
							<div class="card-body pt-1 pb-4">
								...
								<div class="text-center">
                                    ...
                                    <div class="text-muted font-weight-bold mb-1" id="text"></div>
									<div class="text-muted font-weight-bold">---</div>
									<div class="text-muted font-weight-bold mb-1" id="site"></div>
									<div class="text-muted font-weight-bold mb-1" id="ssd"></div>
									<div class="text-muted font-weight-bold mb-1" id="base"></div>
									<div class="text-muted font-weight-bold mb-1" id="ram"></div>
								</div>
								<hr>
...
<script>
	var tarifData = {
		    ...
		    1: {
				'price': 0.00,
				'text': 'Бесплатный тариф, подойдёт для лёгких сайтов. 🤔',
				'ssd': 128,
				'site': 1,
				'ram': 128,
				'base': 1			},
			...
			2: {
				'price': 25.00,
				'text': 'Отлично подойдёт для одностраничного сайта, или же визитки. 🤔',
				'ssd': 512,
				'site': 1,
				'ram': 256,
				'base': 1			},
			...
			3: {
				'price': 50.00,
				'text': 'Отлично подойдёт для мало посещаемого сайта или форума. 😏',
				'ssd': 1024,
				'site': 2,
				'ram': 512,
				'base': 2			},
			...
			4: {
				'price': 100.00,
				'text': 'Отлично подойдёт для посещаемого сайта и форума. 😎',
				'ssd': 2048,
				'site': 5,
				'ram': 1024,
				'base': 5			},
			...
			5: {
				'price': 250.00,
				'text': 'Отлично подойдёт для всего, с большим запасом нагрузки. 🤩',
				'ssd': 5012,
				'site': 10,
				'ram': 1512,
				'base': 10			},
	...
	function updateForm(promo) {
		...
		$('#text').text(''+tarifData[tarifID]['text']+'');
		$('#site').text('Сайтов: '+tarifData[tarifID]['site']+'');
		$('#ssd').text('SSD: '+tarifData[tarifID]['ssd']+' MB');
		$('#base').text('Баз данных: '+tarifData[tarifID]['base']+'');
		$('#ram').text('Оперативная память: '+tarifData[tarifID]['ram']+' MB');
