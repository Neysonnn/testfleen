				...
				<div class="card-body">
					<form id="createForm" method="POST">
						...
						<div class="form-group form-md-line-input">
							...
							<input type="text" class="form-control" id="ns_servers" name="ns_servers" placeholder="Введите NS Сервера локации (ns1.domain.ru и ns2.domain.ru), если нет то просто нет :)">
						</div>
						<div class="form-group form-md-line-input">
						...
						<div class="form-group form-md-line-input">
							...
							<select class="form-control" id="panel" name="panel" aria-required="true" aria-invalid="false" aria-describedby="delivery-error" onChange="toggleReseller()">
								<option value="1">Fastpanel</option>
								<option value="2">ISPmanager 6 (Lite-Pro-Host)</option>
							</select>
						</div>
						<div class="form-group form-md-line-input">
