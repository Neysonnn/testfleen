					...
					<form class="form-group form-md-line-input" id="settings" method="post" action="" novalidate="novalidate">
						<div class="tab-content mt-5">
							...
							<div class="tab-pane fade" id="pay" role="tabpanel">
								...
								<div class="form-group">
									<label>Платежная система: Aaio</label>
									<select class="form-control" id="aaio" name="aaio">
										<option value="1"<?php if($settings['aaio'] == 1): ?> selected="selected"<?php endif; ?>>Включена</option>
										<option value="0"<?php if($settings['aaio'] == 0): ?> selected="selected"<?php endif; ?>>Выключена</option>
									</select>
								</div>
								<div class="form-group">
								...
								<hr>
								<label>Настройка системы: Yoomoney</label>
								<div class="form-group">
								...
								<hr>
								<label>Настройка системы: Aaio</label>
								<div class="form-group">
									<input type="text" class="form-control" id="aaio_id" name="aaio_id" placeholder="Введите ID" value="<?php echo $settings['aaio_id'] ?>">
									<span class="form-text text-muted">Aaio ID</span>
								</div>
								<div class="form-group">
									<input type="text" class="form-control" id="aaio_secret1" name="aaio_secret1" placeholder="Введите секретный ключ #1" value="<?php echo $settings['aaio_secret1'] ?>">
									<span class="form-text text-muted">Секретный ключ #1</span>
								</div>
								<div class="form-group">
									<input type="text" class="form-control" id="aaio_secret2" name="aaio_secret2" placeholder="Введите секретный ключ #2" value="<?php echo $settings['aaio_secret2'] ?>">
									<span class="form-text text-muted">Секретный ключ #2</span>
								</div>
								<hr>
								<label>Настройка системы: Freekassa</label>
