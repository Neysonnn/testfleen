						...
						<div class="col-xl-12">
							<div class="card card-custom mb-3">
								<div class="card-header border-0">
									...
									<h3 class="card-title">Адрес Fastpanel<small class="text-muted font-size-sm ml-2">web.fleen-host.ru</small></h3>
									<div class="card-toolbar">
										<a href="https://web.fleen-host.ru" target="_blank" class="btn btn-clean btn-icon">
									...
									<h3 class="card-title">Адрес ISPmanager<small class="text-muted font-size-sm ml-2">https://<?php echo $webhost['location_url'] ?>:1500</small></h3>
									<div class="card-toolbar">
										<a href="https://<?php echo $webhost['location_url'] ?>:1500" target="_blank" class="btn btn-clean btn-icon">
										<i class="fa fa-external-link-alt" data-toggle="tooltip" data-placement="right" title="" data-original-title="Перейти в панель управления"></i>
										</a>
									</div>
									<?php endif; ?>
