					...
					<div class="card card-custom mb-3">
						<div class="card-body px-1" style="padding: 0.3rem 2.25rem;">
							<div class="navi navi-hover navi-active navi-link-rounded navi-bold navi-icon-center navi-light-icon">
								...
								<?php endif; ?>
								<div class="navi-item my-2">
									<a href="javascript:;" data-toggle="modal" data-target="#settingsfive" class="navi-link">
									<span class="navi-icon mr-3">
									<span class="svg-icon svg-icon-lg">
									<i class="fa fa-cogs"></i>
									</span>
									</span>
									<span class="navi-text font-weight-bolder font-size-lg">Настройки</span>
									</a>
								</div>
							</div>
						</div>
...
<!--begin::Modal-->
<div class="modal fade" id="settingsfive" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Настройки сервера</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
				<i aria-hidden="true" class="ki ki-close"></i>
				</button>
			</div>
			<form id="settingFive" method="POST" style="padding:0px; margin:0px;">
				<div class="modal-body">
					<div class="form-group">
						<label>Введите порт сервера:</label>
						<input type="text" class="form-control" id="server_port" name="server_port" placeholder="Введите игровой порт" value="<?echo $server['server_port']?>">
					</div>
					<div class="form-group">
						<label>Введите ID Владельца:</label>
						<input type="text" class="form-control" id="user_id" name="user_id" placeholder="Введите ID владельца" value="<?echo $server['user_id']?>">
					</div>
					<div class="form-group">
						<label>Дата окончания аренды:</label>
						<input type="text" class="form-control" id="server_date_end" name="server_date_end" placeholder="Введите дату окончания оплаты" value="<?echo $server['server_date_end']?>">
					</div>
					<div class="form-group">
						<label>Смена слотов сервера:</label>
						<input type="text" class="form-control" id="server_slots" name="server_slots" placeholder="Введите количество слотов" value="<?echo $server['server_slots']?>">
					</div>
					<div class="form-group">
						<label>Смена игры сервера:</label>
						<input type="text" class="form-control" id="game_id" name="game_id" placeholder="Введите ID игры" value="<?echo $server['game_id']?>">
						<br>
						<center><code>Установлена игра: <?php echo $server['game_name'] ?></code></center>
					</div>
...
<?php endif; ?>	
<script>
	$('#settingFive').ajaxForm({ 
		url: '/admin/servers/control/settingFive/<?php echo $server['server_id'] ?>',
		dataType: 'text',
		success: function(data) {
			console.log(data);
			data = $.parseJSON(data);
