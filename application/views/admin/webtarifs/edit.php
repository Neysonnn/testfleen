			...
			<div class="card card-custom">
				...
				<div class="card-body">
					<form id="editForm" method="POST">
						...
						<div class="form-group form-md-line-input">
							<label>Введите размер диска в Мегабайтах для Fastpanel (пример: 256)</label>
							<input type="text" class="form-control" id="ssd" name="ssd" placeholder="Введите размер диска в мб (пример: 256)" value="<?php echo $tarif['tarif_ssd'] ?>">
						</div>
						<div class="form-group form-md-line-input">
							<label>Введите название шаблона для ISPmanager 6 (пример: ultra_package)</label>
							<input type="text" class="form-control" id="isppackage" name="isppackage" placeholder="Введите название шаблона для ISPmanager 6 (пример: ultra_package)" value="<?php echo $tarif['tarif_isppackage'] ?>">
						</div>
						<div class="form-group form-md-line-input">
							<label>Введите ID шаблона для Fastpanel (пример: 2)</label>
							<input type="text" class="form-control" id="fastpackage" name="fastpackage" placeholder="Введите ID шаблона для Fastpanel (пример: 2)" value="<?php echo $tarif['tarif_fastpackage'] ?>">
						</div>
						<div class="form-group form-md-line-input">
							<label>Выберите статус SSH для пользователя Fastpanel</label>
							<select class="form-control" id="ssh" name="ssh" name="delivery" aria-required="true" aria-invalid="false" aria-describedby="delivery-error">
								<option value="1"<?php if($tarif['tarif_ssh'] == 1): ?> selected="selected"<?php endif; ?>>Разрешен</option>
								<option value="0"<?php if($tarif['tarif_ssh'] == 0): ?> selected="selected"<?php endif; ?>>Запрещен</option>
							</select>
						</div>
						<div class="form-group form-md-line-input">
