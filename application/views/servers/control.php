...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
	<div class="d-flex flex-column-fluid">
		<div class="container">
			...
			<?php if($server["game_id"] == 1 OR $server["game_id"] == 2): ?>
			<div class="col-xl-12">
							<div class="card card-custom mb-3 mt-3">
								<div class="card-body pt-1 pb-4">
									<p class="text-dark font-weight-boldest font-size-h5 mb-6 mt-3">У Вас бесплатный тариф</p>
									<p class="h6 text-dark">Мы рады что Вы выбрали наш <span class="h6 text-primary font-weight-bold"> хостинг</span>! Вы можете поддержать нашу работу несколькими способами:</p>
									<a target="_blank" href="/servers/order" class="btn btn-black my-3"><i class="bi bi bi-bag text-success mr-1"></i>Купить Pro/Lite сервер</a> 
									<a target="_blank" href="https://vk.com/fleenhost" class="btn btn-black my-3"><i class="fab fa-vk text-info mr-1"></i>Вступить в группу VK</a> 
									<a target="_blank" href="https://t.me/fleenhost" class="btn btn-black my-3"><i class="fab fa-telegram text-info mr-1"></i>Вступить в ТГК</a> 
									<a target="_blank" href="/main/acc" class="btn btn-black my-3"><i class="fab bi bi-people text-warning mr-1"></i>Пригласить друзей</a> 
                     				<a target="_blank" href="https://vk.com/topic-210554805_49412702" class="btn btn-black my-3"><i class="bi bi-pencil-square mr-1"></i>Оставить отзыв</a> 
								</div>
							</div>
						</div>
																		<div class="col-xl-12">
							<div class="card card-custom mb-3 mt-3">
								<div class="card-body pt-1 pb-4">
									<p class="text-dark font-weight-boldest font-size-h5 mb-6 mt-3">Условия бесплатного сервера</p>
									<p class="h6 text-muted mb-6"><i class="bi bi-clock text-info"></i> Максимальный срок сервера: <span class="h6 text-dark font-weight-bold"> 5 дней</span></p>

									<p class="text-dark font-weight-boldest font-size-h5 mb-6 mt-3">Ваш тариф имеет несколько ограничений такие как:</p>
									<p class="h6 text-muted"><i class="bi bi-x text-danger"></i>- Выключение сервера каждый час</p>
									<p class="h6 text-muted"><i class="bi bi-x text-danger"></i>- Пониженные частоты ядра</p>
									<p class="h6 text-muted"><i class="bi bi-x text-danger"></i>- Мало оперативной памяти</p>
									<p class="h6 text-muted"><i class="bi bi-x text-danger"></i>- На тарифном плане FREE тех. поддержка не предоставляется.</p>
								</div>
							</div>
						</div>
			<?php endif; ?>
							...
							<div class="accordion accordion-solid accordion-toggle-plus" id="accordionExample">
								<div class="card">
									...
									<div id="fast_infos" class="card-body-wrapper collapse" aria-labelledby="fast_info" data-parent="#accordionExample" style="">
										<div class="card-body">
											<p>
												sv_downloadurl "http://<?php echo $server['location_ip'] ?>:8080/fastdl_gs<?php echo $server['server_id'] ?>"<br> 
												sv_consistency 1<br> 
												sv_allowupload 1<br> 
												sv_allowdownload 1
											</p>
