...
class editController extends Controller {
	...
	public function ajax($tarifid = null) {
		...
		if($this->request->server['REQUEST_METHOD'] == 'POST') {
			...
			if(!$errorPOST) {
				...
				$ssh = @$this->request->post['ssh'];
				$ssd = @$this->request->post['ssd'];
				$price = @$this->request->post['price'];
				$status = @$this->request->post['status'];
				$isppackage = @$this->request->post['isppackage'];
				$fastpackage = @$this->request->post['fastpackage'];
				...
				$tarifData = array(
					...
					'tarif_ssh'		=> (int)$ssh,
					'tarif_ssd'			=> (int)$ssd,
					'tarif_isppackage'	=> $isppackage,
					'tarif_fastpackage'	=> (int)$fastpackage
				);
	...
	public function delete($tarifid = null) {
		...
		$this->document->setActiveItem('webtarifs');
