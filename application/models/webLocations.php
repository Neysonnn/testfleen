...
class webLocationsModel extends Model {
	public function createLocation($data) {
		...
		$sql .= "location_panel = '" . $this->db->escape($data['location_panel']) . "', ";
		if(!empty($data['location_reseller_status'])) $sql .= "location_reseller_status = '" . (int)$data['location_reseller_status'] . "', ";
