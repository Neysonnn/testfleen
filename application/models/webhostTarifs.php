...
class webhostTarifsModel extends Model {
	public function createTarif($data) {
		...
		if(!empty($data['tarif_ssh'])) $sql .= "`tarif_domains` = '" . $data['tarif_ssh'] . "', ";
		if(!empty($data['tarif_ssd'])) $sql .= "`tarif_ssd` = '" . $data['tarif_ssd'] . "', ";
		if(!empty($data['tarif_isppackage'])) $sql .= "`tarif_isppackage` = '" . $data['tarif_isppackage'] . "', ";
		if(!empty($data['tarif_fastpackage'])) $sql .= "`tarif_fastpackage` = '" . $data['tarif_fastpackage'] . "', ";
